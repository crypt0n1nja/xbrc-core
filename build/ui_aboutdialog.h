...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bitrewards", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Bitrewards</b> version", 0));
...
"Copyright \302\251 2014 The Bitrewards developers", 0));
