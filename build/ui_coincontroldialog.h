...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 XBRC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 XBRC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 XBRC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 XBRC"));
