...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        peerBanBitrewards = new QLabel(detailWidget);
        peerBanBitrewards->setObjectName(QStringLiteral("peerBanBitrewards"));
        peerBanBitrewards->setCursor(QCursor(Qt::IBeamCursor));
        peerBanBitrewards->setTextFormat(Qt::PlainText);
        peerBanBitrewards->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout_3->addWidget(peerBanBitrewards, 7, 2, 1, 1);
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Bitrewards - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Bitrewards Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Bitrewards debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Bitrewards-Qt help message to get a list with possible Bitrewards command-line options.", 0));
#endif // QT_NO_TOOLTIP
        ...
        label_24->setText(QApplication::translate("RPCConsole", "Ban Bitrewards", 0));
        peerBanBitrewards->setText(QApplication::translate("RPCConsole", "N/A", 0));
