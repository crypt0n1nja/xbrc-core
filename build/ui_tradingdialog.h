...
public:
    ...
    QLabel *label_11;
    QLabel *FORBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *FORAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *FORPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        FORAvailableLabel = new QLabel(BuyTab);
        FORAvailableLabel->setObjectName(QStringLiteral("FORAvailableLabel"));
        QPalette palette1;
        ...
        FORAvailableLabel->setPalette(palette1);
        FORAvailableLabel->setFont(font3);
        FORAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(FORAvailableLabel);

        labelFOR = new QLabel(BuyTab);
        labelFOR->setObjectName(QStringLiteral("labelFOR"));
        labelFOR->setFont(font3);

        horizontalLayout->addWidget(labelFOR);
        ...
        UnitsInputFOR = new QLineEdit(BuyTab);
        UnitsInputFOR->setObjectName(QStringLiteral("UnitsInputFOR"));
        UnitsInputFOR->setMinimumSize(QSize(0, 0));
        UnitsInputFOR->setFont(font5);

        gridLayout_6->addWidget(UnitsInputFOR, 4, 9, 1, 1);
        ...
        BuyFOR = new QPushButton(BuyTab);
        BuyFOR->setObjectName(QStringLiteral("BuyFOR"));

        gridLayout_6->addWidget(BuyFOR, 7, 3, 1, 1);

        SellFORBTN = new QPushButton(BuyTab);
        SellFORBTN->setObjectName(QStringLiteral("SellFORBTN"));

        gridLayout_6->addWidget(SellFORBTN, 7, 9, 1, 1);
        ...
        FORDemand = new QLabel(BuyTab);
        FORDemand->setObjectName(QStringLiteral("FORDemand"));
        QFont font6;
        font6.setPointSize(8);
        FORDemand->setFont(font6);
        FORDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(FORDemand, 0, 1, 1, 5);

        FORSupply = new QLabel(BuyTab);
        FORSupply->setObjectName(QStringLiteral("FORSupply"));
        FORSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(FORSupply, 0, 9, 1, 3);
        ...
        BittrexFORLabel = new QLabel(tab);
        BittrexFORLabel->setObjectName(QStringLiteral("BittrexFORLabel"));
        QPalette palette7;
        ...
        BittrexFORLabel->setPalette(palette7);
        BittrexFORLabel->setFont(font7);
        BittrexFORLabel->setAutoFillBackground(false);
        BittrexFORLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexFORLabel);
        ...
        FORBalanceLabel = new QLabel(BalanceTab);
        FORBalanceLabel->setObjectName(QStringLiteral("FORBalanceLabel"));
        FORBalanceLabel->setFont(font4);
        FORBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(FORBalanceLabel, 0, 3, 1, 1);
        ...
        FORAvailableLabel_2 = new QLabel(BalanceTab);
        FORAvailableLabel_2->setObjectName(QStringLiteral("FORAvailableLabel_2"));
        FORAvailableLabel_2->setFont(font4);
        FORAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(FORAvailableLabel_2, 1, 3, 1, 1);
        ...
        FORPendingLabel = new QLabel(BalanceTab);
        FORPendingLabel->setObjectName(QStringLiteral("FORPendingLabel"));
        FORPendingLabel->setFont(font4);
        FORPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(FORPendingLabel, 2, 3, 1, 1);
        ...
        FORBalanceLabel->raise();
        FORAvailableLabel_2->raise();
        FORPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "XBRC Available:", 0));
        FORAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelFOR->setText(QApplication::translate("tradingDialog", " XBRC", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "XBRC", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "XBRC", 0));
        ...
        BuyFOR->setText(QApplication::translate("tradingDialog", "Buy XBRC", 0));
        SellFORBTN->setText(QApplication::translate("tradingDialog", "Sell XBRC", 0));
        ...
        FORDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 XBRC", 0));
        FORSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 XBRC", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in XBRC:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "XBRC", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "XBRC Balance:", 0));
        BittrexFORLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "XBRC", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "XBRC Balance:", 0));
        FORBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "XBRC Available:", 0));
        FORAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "XBRC Pending:", 0));
        FORPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate XBRC Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw XBRC:", 0));
