...
void ResendWalletTransactions(bool fBitrewards = false);
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // ppcoin: trust Bitrewards of block chain
    int nHeight;
#ifndef LOWMEM
    int64_t nMint;
...
protected:
    ...
    virtual void ResendWalletTransactions(bool fBitrewards) =0;
