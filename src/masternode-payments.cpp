...
uint64_t CMasternodePayments::CalculateBitrewards(uint256 blockHash, CTxIn& vin)
{
    ...
    //printf(" -- CMasternodePayments CalculateBitrewards() n2 = %d \n", n2.Get64());
    //printf(" -- CMasternodePayments CalculateBitrewards() n3 = %d \n", n3.Get64());
    //printf(" -- CMasternodePayments CalculateBitrewards() n4 = %d \n", n4.Get64());
...
bool CMasternodePayments::AddWinningMasternode(CMasternodePaymentWinner& winnerIn)
{
    ...
    winnerIn.Bitrewards = CalculateBitrewards(blockHash, winnerIn.vin);

    bool foundBlock = false;
    BOOST_FOREACH(CMasternodePaymentWinner& winner, vWinning){
        if(winner.nBlockHeight == winnerIn.nBlockHeight) {
            foundBlock = true;
            if(winner.Bitrewards < winnerIn.Bitrewards){
                winner.Bitrewards = winnerIn.Bitrewards;
