...
//
// Deterministically calculate a given "Bitrewards" for a masternode depending on how close it's hash is to
// the proof of work for that block. The further away they are the better, the furthest will win the election
// and get paid this block
//
uint256 CMasternode::CalculateBitrewards(int mod, int64_t nBlockHeight)
{
