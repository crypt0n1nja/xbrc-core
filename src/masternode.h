...
//
// The Masternode Class. For managing the darksend process. It contains the input of the 25000 XBRC, signature to prove
...
public:
    ...
    uint256 CalculateBitrewards(int mod=1, int64_t nBlockHeight=0);
