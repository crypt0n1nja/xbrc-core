...
/**
 * Split Bitrewards command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bitrewards RPC console.") + "<br>" +
...
void RPCConsole::on_lineEdit_returnPressed()
{
    ...
    if(!cmd.isEmpty())
    {
        ...
        history.append(cmd);
        // EnBitrewards maximum history size
...
void RPCConsole::updateNodeDetail(const CNodeCombinedStats *stats)
{
    ...
    if (stats->fNodeStateStatsAvailable) {
        // Ban Bitrewards is init to 0
        ui->peerBanBitrewards->setText(QString("%1").arg(stats->nodeStateStats.nMisbehavior));

    } else {
        ui->peerBanBitrewards->setText(tr("Fetching..."));
    }
