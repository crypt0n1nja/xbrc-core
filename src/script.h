 ...
 *  A CTxDestination is the internal data type encoded in a CBitrewardscoinAddress
 */
 ...
 * numeric operation). CScriptNum enBitrewardss those semantics by storing results as
