// Copyright (c) 2015 The XBRC developers
...
bool IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        if(nSporkID == SPORK_1_MASTERNODE_PAYMENTS_ENXBRCMENT) r = SPORK_1_MASTERNODE_PAYMENTS_ENXBRCMENT_DEFAULT;
        ...
        if(nSporkID == SPORK_8_MASTERNODE_PAYMENT_ENXBRCMENT) r = SPORK_8_MASTERNODE_PAYMENT_ENXBRCMENT_DEFAULT;
        if(nSporkID == SPORK_9_MASTERNODE_BUDGET_ENXBRCMENT) r = SPORK_9_MASTERNODE_BUDGET_ENXBRCMENT_DEFAULT;
...
{
    if(strName == "SPORK_1_MASTERNODE_PAYMENTS_ENXBRCMENT") return SPORK_1_MASTERNODE_PAYMENTS_ENXBRCMENT;
    ...
    if(strName == "SPORK_8_MASTERNODE_PAYMENT_ENXBRCMENT") return SPORK_8_MASTERNODE_PAYMENT_ENXBRCMENT;
    if(strName == "SPORK_9_MASTERNODE_BUDGET_ENXBRCMENT") return SPORK_9_MASTERNODE_BUDGET_ENXBRCMENT;
...
{
    if(id == SPORK_1_MASTERNODE_PAYMENTS_ENXBRCMENT) return "SPORK_1_MASTERNODE_PAYMENTS_ENXBRCMENT";
    ...
    if(id == SPORK_8_MASTERNODE_PAYMENT_ENXBRCMENT) return "SPORK_8_MASTERNODE_PAYMENT_ENXBRCMENT";
    if(id == SPORK_9_MASTERNODE_BUDGET_ENXBRCMENT) return "SPORK_9_MASTERNODE_BUDGET_ENXBRCMENT";
